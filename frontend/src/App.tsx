...
export default function App() {
  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Agentic AI Legal Contract Reviewer & Citation Engine</h1>
      <p style={{ color: '#666' }}>Autonomous legal contract risk analysis, clause comparison, liability auditing, and statutory citation mapping.</p>
