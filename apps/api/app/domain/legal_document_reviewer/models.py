...
class AgenticLegalDocumentReviewerSession(Base):
    __tablename__ = "legal_document_reviewer_sessions"
...
class AgenticLegalDocumentReviewerItem(Base):
    __tablename__ = "legal_document_reviewer_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("legal_document_reviewer_sessions.id"))
